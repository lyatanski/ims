...
- IMS
  - Stage 2 [TS 23.228](https://www.etsi.org/deliver/etsi_ts/123200_123299/123228/18.07.00_60/ts_123228v180700p.pdf)
  - Stage 3 [TS 24.229](https://www.etsi.org/deliver/etsi_ts/124200_124299/124229/18.06.00_60/ts_124229v180600p.pdf)
...
- IMS (compose.yml)
  ...
  - [x] [DNS](doc/images.md#coredns)
    - [x] ENUM — a dialled number translated to a SIP URI, off-range numbers broken out to a trunk ([session flow](doc/session.md))
